...
def test_new_build_preserves_fix3_and_fix4_date_identity():
    ...
    assert policy.identity_for_signal_day(date(2026, 9, 28)) == (policy.FIX7_BUILD_ID, policy.FIX7_RULE_REVISION)
    assert policy.identity_for_signal_day(date(2026, 9, 29)) == (policy.BUILD_ID, policy.RULE_REVISION)
