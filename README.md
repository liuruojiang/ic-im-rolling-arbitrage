...
- 上传入口为`poe_ic_im_mainline_v1_2_bot.py`，当前构建号为`v1.2-20260824-r14`；头像素材为`assets/poe_ic_im_v1_2_avatar.png`。
- 历史绩效查询使用1.2重组曲线，并以真实行情续接；2026-08-21月换日已经按旧腿盯市、新腿收盘接续及交易成本完成逐腿核验。
- 实时信号以2026-08-21最后逐腿核验状态为锚点。若后续行情无法完整重放期货、Put、Call及成本状态，Bot会暂停新增信号，只显示带日期的只读快照。
