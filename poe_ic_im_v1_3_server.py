"""Persistent FastAPI/Poe server for the IC/IM v1.3 research surface.
...
from poe_ic_im_v1_3_state import StateStore, anchors_from_record, close_clock
...
class LedgerCoordinator:
    def __init__(self, store: StateStore | None = None) -> None:
        ...
        if require_migration and not self.store.latest_path.is_file():
            raise RuntimeError("部署卷缺少已迁移的v1.3账本，禁止静默创建创世状态")
